...
enum PlayerType {PLAYER_TUTORIAL = 0, PLAYER_1, PLAYER_2, PLAYER_3, NONE = -1}
enum EnemyType {ENEMY_TUTORIAL = 0, ENEMY_1, ENEMY_2, ENEMY_3, ENEMY_4}
enum CivilianType {CIVILIAN_TUTORIAL = 0, CIVILIAN_1}
enum ItemType {ITEM_1 = 1, ITEM_2, ITEM_3, ITEM_4, ITEM_5, NONE = -1}
