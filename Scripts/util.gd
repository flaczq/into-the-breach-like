...
enum EpochType {PREHISTORIC, MIDDLE_AGES, RENAISSANCE, PRESENT_DAY, FUTURE, NONE = -1}
...
enum LevelObjective {JUST_WIN, LESS_THAN_HALF_TILES_DAMAGED, ALL_ENEMIES_DEAD, NO_PLAYERS_DEAD, NO_CIVILIANS_DEAD, SURVIVE_UNTIL_TURN_5, SURVIVE_UNTIL_TURN_6}
