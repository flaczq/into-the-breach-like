...
var player_2_active_texture: CompressedTexture2D = preload('res://Assets/aaaps/player_2_active.png')
...
func _ready() -> void:
	...
	textures = [player_2_normal_texture, player_2_active_texture]
...
func get_data() -> Dictionary:
	return {
		...
		'textures': [player_2_normal_texture, player_2_active_texture] as Array[CompressedTexture2D],
